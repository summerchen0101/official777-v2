    ...
    <section className="rule">
      <div className="lg:w-[860px] mx-auto">
        ...
        <p>
          ...
          LIMITED公司【OOOOOO】遊戲平台（以下簡稱本遊戲），為保障你的權益，請於註冊成為本遊戲會員並開始使用本遊戲之服務前，詳細閱讀本服務條款之所有內容。
        </p>
        ...
        <ol>
          ...
          <li>
            乙方於本遊戲官網（___________________）首頁、遊戲登入頁面或購買頁面以明顯標示本服務條款，若甲方為限制行為能力人或無行為能力人，除應符合第一項規定外，並應於甲方之法定代理人閱讀、瞭解並同意本服務條款之所有內容後，方得使用本遊戲服務。本服務條款嗣後有變更時亦同。
          </li>
          <li>
        ...
        <p>
          一、依遊戲軟體分級管理辦法規定標示，本遊戲為【
          】級，甲方須為_____歲以上方得註冊進行本遊戲。
        </p>
        ...
        <ol>
          ...
          <li>
            乙方應於官網或本遊戲中明示服務專線（）、電子郵件（　　）或郵寄地址（　）等相關申訴管道。
          </li>
        </ol>
        <p className="mt-3">
