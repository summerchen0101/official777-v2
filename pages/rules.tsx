  ...
  return (
    <section className="mt-16 rule">
      <div className="lg:w-[860px] mx-auto">
        ...
        <p>
          <span>歡迎來到香港商</span>
          <span>MEGA GAME GLOBAL TECH LIMITED</span>
          <span>公司【</span>
          <span>OOOOOO</span>
          <span>
            】遊戲平台（以下簡稱本遊戲），為保障你的權益，請於註冊成為本遊戲會員並開始使用本遊戲之服務前，詳細閱讀本服務條款之所有內容。
          </span>
        </p>
        <p>
          <span>提醒您，要先行審閱，再按下【我同意】鍵。</span>
        </p>
        <p>
          <span>當事人：</span>
        </p>
        <p>
          <span>消費者（以下簡稱「甲方」，請依會員註冊流程填寫）</span>
        </p>
        <p>
          <span>企業經營者名稱：香港商</span>
          <span>MEGA GAME GLOBAL TECH LIMITED</span>
          <span>公司（以下簡稱「乙方」）</span>
        </p>
        <p>
          <span>電子郵件： </span>
        ...
        <p>
          <span>營業所地址： </span>
          <span>
            UNIT 2202 22/F West Exchange Tower 332 DES VOEUX Road, Central
            Sheung Wan
          </span>
        </p>
        <p>
          <span>統一編號： 73031517-000-05-21-0</span>
        </p>
        <p className="mt-3">
        ...
        <ol>
          ...
          <li>
            ...
            <span>
              ）首頁、遊戲登入頁面或購買頁面以明顯標示本服務條款，若甲方為限制行為能力人或無行為能力人，除應符合第一項規定外，並應於甲方之法定代理人閱讀、瞭解並同意本服務條款之所有內容後，方得使用本遊戲服務。本服務條款嗣後有變更時亦同。
            </span>
          </li>
          <li>
            <span>
        ...
        <ol>
          <li>
            <span> 除本服務條款外，以下視為甲方及乙方間契約內容之一部分：</span>
          </li>
        </ol>
        <p>
          <span>一、乙方有關本遊戲服務之廣告或宣傳內容。</span>
        </p>
        <p>
          <span>二、乙方之隱私權政策。</span>
        </p>
        <ol>
          <li>
            <span> 本服務條款如有疑義時，應為甲方有利之解釋。</span>
          </li>
        </ol>
        <p className="mt-3">
        ...
        <ol>
          ...
          <li>
            <span>甲方</span>
            <span>
              認知且同意，訪問和/或使用本遊戲（包括本遊戲應用程式上提供的任何或全部服務或產品）在某些國家/地區可能是非法或受限制的。乙方對於甲方使用本遊戲在甲方所在地之合法性不提供任何形式之保證與擔保。
            </span>
          </li>
          <li>
            <span>
        ...
        <ol>
          ...
          <li>
            <span>
              為確保甲方使用本遊戲服務之權益，甲方應保證其提供之資料為真實、正確，且提供之資料應可驗證身分，若有不正確或已變更時，應立即通知乙方更新，若甲方提供之資料有未即時更新、不正確或偽造、變造之情形，其衍生之所有責任由甲方自行負擔。
            </span>
            <span>
              如乙方無法依據甲方留存之個人資料確認甲方身分，乙方有權拒絕甲方提供服務之要求。
            </span>
          </li>
          <li>
            <span>
        ...
        <ol>
          ...
          <li>
            <span>前項情形，甲方得就未使用之付費購買點數向乙方請求退費。</span>
          </li>
        </ol>
        <p className="mt-3">
        ...
        <ol>
          ...
          <li>
            <span>費率調整時，乙方應於預定調整生效日</span>
            <span>三十</span>
            <span>日前於官網首頁、遊戲登入頁面或購買頁面公告。</span>
          </li>
          <li>
            <span>
        ...
        <p>
          <span>一、依遊戲軟體分級管理辦法規定標示，本遊戲為</span>
          <span>【 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 】</span>
          <span>級，甲方須為</span>
          <span>_____</span>
          <span>歲以上方得註冊進行本遊戲。</span>
        </p>
        <p>
          <span>二、進行本遊戲服務之最低軟硬體需求</span>
          <span>（　　　　　　　　　　　　　　　）</span>
          <span>。</span>
        </p>
        <p>
          <span>三、有提供安全裝置者，其免費或付費資訊。</span>
        </p>
        <p>
          <span>
        ...
        <ol>
          <li>
            <span>甲方完成註冊程序後取得之帳號及密碼，限供甲方使用。</span>
          </li>
          <li>
            <span>
        ...
        <p>
          <span>關於個人資料之保護，依乙方隱私權政策及相關法律規定處理。</span>
        </p>
        <p className="mt-3">
        ...
        <ol>
          <li>
            <span>
              甲方不滿意乙方提供之連線品質、遊戲管理、費用計費、其他相關之服務品質，或對乙方依遊戲規則之處置不服時，得於收到通知之翌日起七日內至乙方之服務中心或以電子郵件或書面提出申訴，乙方應於接獲申訴後，於
            </span>
            <span>十五</span>
            <span>日內回覆處理之結果。</span>
          </li>
          <li>
            <span>乙方應於官網或本遊戲中明示服務專線</span>
            <span>（　　　　　　　　）</span>
            <span>、電子郵件</span>
            <span>
              （　　　　　　　　　　）或郵寄地址（　　　　　　　　　）
        ...
        <ol>
          <li>
            <span>甲方</span>
            <span>得隨時關閉帳號並終止契約，並聯繫乙方辦理後續。</span>
          </li>
          <li>
            <span>
          ...
          <ol>
            ...
            <li>
              <span>甲方出於非法或不正當目的而購買虛擬點數或遊戲內商品</span>
            </li>
            <li>
              <span>
            ...
            <li>
              <span>
                因同一事由違反遊戲規則達三次以上，經通知改善而未改善者
              </span>
            </li>
            <li>
              <span>依檢警單位、任何監管機構或法庭之要求</span>
            </li>
          </ol>
          <li>
            <span>
        ...
        <div>
          ...
          <ol>
            ...
            <li>
              <span>
                甲方理解並同意必須遵守提供本遊戲下載之平台業者（如Google
                Play、App Store等提供者，下稱「平台業者」）之條款以使用本遊戲。
              </span>
            </li>
            <li>
              <span>
