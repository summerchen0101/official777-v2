              ...
              <div className="ranking-box-goldline">
                <div className="ranking-box-black">
                  <div className="content-box">
                    ...
                    <ul>
                      <li>
                        依遊戲軟體分級管理辦法規定標示，本遊戲為【限制】級，甲方須為18歲以上方得註冊進行本遊戲。
                      </li>
                      <li>
                        進行本遊戲服務之最低軟硬體需求
                        <br />
                    ...
                    <ul>
                      ...
                      <li>
                        乙方應於官網或本遊戲中明示服務專線（02-87761077）、電子郵件（support@online539.com）或郵寄地址（台北市信義區松仁路101號12樓）等相關申訴管道。
                      </li>
                    </ul>
                    <h4>第十八條　契約之終止與退費</h4>
                    <ul>
                      <li>
                        甲方得隨時關閉帳號並終止契約，並聯繫乙方辦理後續。
                      </li>
                      <li>
