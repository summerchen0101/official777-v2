            ...
            <div className="ranking-box-gold">
              <div className="ranking-box-goldline">
                <div className="ranking-box-black">
                  <div className="content-box">
                    <h1 className="text-center">魔法消消樂</h1>
                    <hr />
                    ...
                    <img
                      src="/images/novice/gameplay/slot29/GameInfo_29_1.jpg"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <div className="mini-title-box">
                    ...
                    <img
                      src="/images/novice/gameplay/slot29/GameInfo_29_2.jpg"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <div className="mini-title-box">
                    ...
                    <img
                      src="/images/novice/gameplay/slot29/GameInfo_29_3.jpg"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <img
                      src="/images/novice/gameplay/slot29/GameInfo_29_4.jpg"
                      alt=""
                      className="img-responsive center-block"
                    />
                  </div>
