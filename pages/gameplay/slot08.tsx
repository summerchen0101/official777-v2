            ...
            <div className="ranking-box-gold">
              <div className="ranking-box-goldline">
                <div className="ranking-box-black">
                  <div className="content-box">
                    <h1 className="text-center">舞姬貂蟬</h1>
                    <hr />
                    ...
                    <img
                      src="/images/novice/gameplay/slot08/GameInfo_27_1.png"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <div className="mini-title-box">
                    ...
                    <img
                      src="/images/novice/gameplay/slot08/GameInfo_27_2.png"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <div className="mini-title-box">
                    ...
                    <img
                      src="/images/novice/gameplay/slot08/GameInfo_27_3.png"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <img
                      src="/images/novice/gameplay/slot08/GameInfo_27_4.png"
                      alt=""
                      className="img-responsive center-block"
                    />
                  </div>
