            ...
            <div className="ranking-box-gold">
              <div className="ranking-box-goldline">
                <div className="ranking-box-black">
                  <div className="content-box">
                    <h1 className="text-center">3D高倍21點</h1>
                    <hr />
                    ...
                    <img
                      src="/images/novice/gameplay/gamble05/GameInfo_1001_1.jpg"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <img
                      src="/images/novice/gameplay/gamble05/GameInfo_1001_2.jpg"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <img
                      src="/images/novice/gameplay/gamble05/GameInfo_1001_3.jpg"
                      alt=""
                      className="img-responsive center-block"
                    />
                  </div>
