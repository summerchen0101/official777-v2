            ...
            <div className="ranking-box-gold">
              <div className="ranking-box-goldline">
                <div className="ranking-box-black">
                  <div className="content-box">
                    <h1 className="text-center">彈珠PK10</h1>
                    <hr />
                    ...
                    <img
                      src="/images/novice/gameplay/other07/GameInfo_9001_2.png"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <div className="mini-title-box">
                    ...
                    <img
                      src="/images/novice/gameplay/other07/GameInfo_9001_1.png"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <div className="mini-title-box">
                    ...
                    <img
                      src="/images/novice/gameplay/other07/GameInfo_9001_3.png"
                      alt=""
                      className="img-responsive center-block"
                    />
                  </div>
