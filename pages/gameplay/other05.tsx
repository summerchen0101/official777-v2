            ...
            <div className="ranking-box-gold">
              <div className="ranking-box-goldline">
                <div className="ranking-box-black">
                  <div className="content-box">
                    <h1 className="text-center">幸運大輪盤</h1>
                    <hr />
                    ...
                    <img
                      src="/images/novice/gameplay/other05/other_05_1.jpg"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <img
                      src="/images/novice/gameplay/other05/other_05_2.jpg"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <div className="mini-title-box">
                    ...
                    <img
                      src="/images/novice/gameplay/other05/other_05_3.jpg"
                      alt=""
                      className="img-responsive center-block"
                    />
                  </div>
