            ...
            <div className="ranking-box-gold">
              <div className="ranking-box-goldline">
                <div className="ranking-box-black">
                  <div className="content-box">
                    <h1 className="text-center">西部牛仔</h1>
                    <hr />
                    ...
                    <img
                      src="/images/novice/gameplay/slot06/GameInfo_11_1.png"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <div className="mini-title-box">
                    ...
                    <img
                      src="/images/novice/gameplay/slot06/GameInfo_11_2.png"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <div className="mini-title-box">
                    ...
                    <img
                      src="/images/novice/gameplay/slot06/GameInfo_11_3.png"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <img
                      src="/images/novice/gameplay/slot06/GameInfo_11_4.png"
                      alt=""
                      className="img-responsive center-block"
                    />
                  </div>
