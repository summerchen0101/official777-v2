            ...
            <div className="ranking-box-gold">
              <div className="ranking-box-goldline">
                <div className="ranking-box-black">
                  <div className="content-box">
                    <h1 className="text-center">百人射龍門</h1>
                    <hr />
                    ...
                    <img
                      src="/images/novice/gameplay/gamble04/GameInfo_6003_1.png"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <img
                      src="/images/novice/gameplay/gamble04/GameInfo_6003_2.png"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <img
                      src="/images/novice/gameplay/gamble04/GameInfo_6003_3.png"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <img
                      src="/images/novice/gameplay/gamble04/GameInfo_6003_4.png"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <div className="mini-title-box">
                    ...
                    <img
                      src="/images/novice/gameplay/gamble04/GameInfo_6003_5.png"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <img
                      src="/images/novice/gameplay/gamble04/GameInfo_6003_6.png"
                      alt=""
                      className="img-responsive center-block"
                    />
                  </div>
