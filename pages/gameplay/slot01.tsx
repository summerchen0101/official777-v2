            ...
            <div className="ranking-box-gold">
              <div className="ranking-box-goldline">
                <div className="ranking-box-black">
                  <div className="content-box">
                    <h1 className="text-center">年年有瑜</h1>
                    <hr />
                    ...
                    <img
                      src="/images/novice/gameplay/slot01/GameInfo_28_1.png"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <div className="mini-title-box">
                    ...
                    <img
                      src="/images/novice/gameplay/slot01/GameInfo_28_2.png"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <div className="mini-title-box">
                    ...
                    <img
                      src="/images/novice/gameplay/slot01/GameInfo_28_3.png"
                      alt=""
                      className="img-responsive center-block"
                    />
                    <img
                      src="/images/novice/gameplay/slot01/GameInfo_28_4.png"
                      alt=""
                      className="img-responsive center-block"
                    />
                  </div>
