...
const objList = [
  {
    name: '免費遊戲注額卷 100(碎片)',
    desc: `收集{0}張可以獲得一次SLOT GAME，注額100的免費遊戲`,
    img: '/obj/item_FG_piecesLV1.png',
  },
  {
    name: '免費遊戲注額卷 1,000(碎片)',
    desc: `收集{0}張可以獲得一次SLOT GAME，注額1000的免費遊戲`,
    img: '/obj/item_FG_piecesLV2.png',
  },
  {
    name: '免費遊戲注額卷 10,000(碎片)',
    desc: `收集{0}張可以獲得一次SLOT GAME，注額10000的免費遊戲`,
